...
# installed.
TCL_PREFIX='/home/sudhanshu-pandey/Downloads/PROJECTS/hand-landmarks-detector-main/MediaPipe/venv'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/sudhanshu-pandey/Downloads/PROJECTS/hand-landmarks-detector-main/MediaPipe/venv'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/sudhanshu-pandey/Downloads/PROJECTS/hand-landmarks-detector-main/MediaPipe/venv/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/sudhanshu-pandey/Downloads/PROJECTS/hand-landmarks-detector-main/MediaPipe/venv/include'
...
TCL_PACKAGE_PATH='{/home/sudhanshu-pandey/Downloads/PROJECTS/hand-landmarks-detector-main/MediaPipe/venv/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/sudhanshu-pandey/Downloads/PROJECTS/hand-landmarks-detector-main/MediaPipe/venv/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/croot/tk_1714770549989/work/tcl8.6.14/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/home/sudhanshu-pandey/Downloads/PROJECTS/hand-landmarks-detector-main/MediaPipe/venv/lib/libtclstub8.6.a'
